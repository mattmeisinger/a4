...
javac -classpath ${HADOOP_HOME}/hadoop-core-${HADOOP_VERSION}.jar -d java/MapReduce/bin java/MapReduce/src/org/columbia/WordCount.java

# jar java file (it requires 'cd'ing into the proper path...not sure how to get the 'jar' app to work without all these 'cd's)
rm java/MapReduce/WordCount.jar
...
~/hadoop-1.1.2/bin/hadoop jar java/MapReduce/bin/WordCount.jar org.columbia.WordCount test-input test-output